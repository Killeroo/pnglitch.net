...
namespace pnglitch
{
	// TODO: Work out which one is best
	// Or dont ¯\_(ツ)_/¯
	public static class Checksums
    {
		...
		// From reference:
		public static byte[] Adler32(byte[] stream, int offset,
			   int length)
		{
			var adler = 1;
			var len = length;
        ...
        public static uint Crc32(byte[] data, int index, int length)
        {
            var c = 0xffffffff;
